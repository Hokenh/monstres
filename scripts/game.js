var app = new Vue({
    ...
    data: {
        ...
        languages: {
            "ca": {
                code: "ca",
                name: "Català",
                instructionsURL: "instructions/catala.html",
            },
            "es": {
                code: "es",
                name: "Español",
                instructionsURL: "instructions/espanyol.html",
            },
            "en": {
                code: "en",
                name: "English",
                instructionsURL: "instructions/english.html",
            },
        },
        selectedLanguage: "ca",
        i18n: {
            "ca": {
                ...
                print: "Imprimir",
                newCardbody: "Nou cos",
                newCardeyes: "Nous ulls",
                newCardnose: "Nou nas",
                newCardmouth: "Nova boca",
                newCardcomplement: "Nou complement"
            },
            "es": {
                body: "Cuerpo",
                eyes: "Ojos",
                ...
                print: "Imprimir",
                newCardbody: "Nuevo cuerpo",
                newCardeyes: "Nuevos ojos",
                newCardnose: "Nueva nariz",
                newCardmouth: "Nueva boca",
                newCardcomplement: "Nuevo complemento"
            },
            "en": {
                body: "Body",
                eyes: "Eyes",
                ...
                print: "Print",
                newCardbody: "New body",
                newCardeyes: "New eyes",
                newCardnose: "New nose",
                newCardmouth: "New mouth",
                newCardcomplement: "New complement"
            }
        },
        currentHand: null
    },
    ...
    computed: {
        instructionslink() {
            return this.lanselectedLanguage
    ...
    methods: {
        t(ts) {
            ...
            if (this.i18n.hasOwnProperty(this.selectedLanguage) && this.i18n[this.selectedLanguage].hasOwnProperty(ts)) {
                return this.i18n[this.selectedLanguage][ts];
            }
            return ts;
